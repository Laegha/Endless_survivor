...
public class ThrowAtEnemySupportObjBehaviour : SupportObjectBehaviour
{
    ...
    void CalculateDirection()
    {
        ...
        if (_trayectoryPreviewLineData == null)
            return;
        LineXConfig previewLineConfig = new(_trayectoryPreviewLineData, _verticalMovementCurve, _curveMultiplier, _throwSpeed, _distBetweenPreviewVertices, ObjControl.transform.position, _throwDirection, _totalDistance, true, () => ObjControl == null, ObjControl.transform);
