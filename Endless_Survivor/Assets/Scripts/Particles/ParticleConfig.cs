...
public class ParticleConfig
{
    ...
    public ParticleConfig(ParticleSystem particlesPrefab, Vector3 particlesPosition, Quaternion particlesRotation, float particlesDuration = 1f, Transform particlesParentTransform = null)
    {
